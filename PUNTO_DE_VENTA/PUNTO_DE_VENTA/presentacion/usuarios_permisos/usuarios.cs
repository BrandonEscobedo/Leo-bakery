...
namespace PUNTO_DE_VENTA
{
    public partial class usuarios : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            panel_insertar.Visible = true;
            panel_insertar.Dock = DockStyle.Fill;
        ...
        private void btn_actualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtnombre_apellidos.Text == "" | icono.Image == null | txt_password.Text == "" | txt_usuario.Text == "")

                {
                    MessageBox.Show("Llenar todos los recuadros antes de continuar", "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                try
                ...
                cmd.Parameters.AddWithValue("@password", conexion.encriptar_en_texto.Encriptar(txt_password.Text));
        ...
        private void mostrar()
        {
            try
            {
                ...
                con.Close();
                panel_insertar.Visible = false;
                panel_insertar.Dock = DockStyle.None;
